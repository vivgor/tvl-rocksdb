...
use tvl_librocksdb_sys::{rocksdb::PinnableSlice, ReadOptionsWrapper};

use crate::{slice::PinnedSlice, DbIterator, Direction, Result, Transaction, TransactionDb};

pub struct Snapshot {
    pub(crate) inner: *const tvl_librocksdb_sys::rocksdb::Snapshot,
...
pub struct SharedSnapshot {
    ...
    pub(crate) inner: SharedPtr<tvl_librocksdb_sys::rocksdb::Snapshot>,
    pub(crate) db: TransactionDb,
}
...
impl SharedSnapshot {
    fn as_inner(&self) -> &tvl_librocksdb_sys::rocksdb::Snapshot {
...
pub struct SnapshotRef<'a> {
    pub(crate) inner: &'a tvl_librocksdb_sys::rocksdb::Snapshot,
