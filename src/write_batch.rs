...
pub struct WriteBatch {
    pub(crate) inner: UniquePtr<tvl_librocksdb_sys::rocksdb::WriteBatch>,
...
impl WriteBatch {
    ...
    pub fn as_inner_mut(&mut self) -> Pin<&mut tvl_librocksdb_sys::rocksdb::WriteBatch> {
    ...
    pub fn as_inner(&self) -> &tvl_librocksdb_sys::rocksdb::WriteBatch {
        &self.inner
    }
}
